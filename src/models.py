...
class Quote(Base):
    ...
    __table_args__ = (UniqueConstraint("asset_id", "quote_date", name="unique_asset_date"),)
...
class Position(Base):
    ...
    __table_args__ = (UniqueConstraint("portfolio_id", "ticker", name="unique_portfolio_ticker"),)
