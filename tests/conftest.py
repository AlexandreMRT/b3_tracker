...
def sample_quotes(db_session, sample_assets):
    ...
    quote_data = {
        "PETR4.SA": dict(
            ...
            dividend_yield=8.5,
            beta=1.3,
            signal_golden_cross=1,
            signal_death_cross=0,
            signal_rsi_oversold=0,
            signal_rsi_overbought=0,
            signal_52w_high=0,
            signal_52w_low=0,
            ...
            volume_ratio=1.12,
            news_sentiment_pt=0.35,
            news_sentiment_en=0.20,
            news_sentiment_combined=0.28,
            news_count_pt=5,
            news_count_en=3,
        ...
        "VALE3.SA": dict(
            ...
            signal_death_cross=1,
            signal_rsi_oversold=1,
            signal_rsi_overbought=0,
            signal_52w_high=0,
            signal_52w_low=0,
            signal_volume_spike=0,
            ...
            volatility_30d=2.8,
            avg_volume_20d=28_000_000,
            volume_ratio=1.07,
            news_sentiment_pt=-0.25,
            news_sentiment_en=-0.10,
            news_sentiment_combined=-0.18,
            news_count_pt=4,
            news_count_en=2,
        ...
        "AAPL": dict(
            ...
            news_sentiment_en=0.42,
            news_sentiment_combined=0.42,
            news_count_pt=0,
            news_count_en=6,
        ...
        "BTC-USD": dict(
            price_brl=620_000.00,
            price_usd=100_000.00,
            open_price=99_000.00,
            high_price=101_500.00,
            low_price=98_500.00,
            ...
            above_ma_200=1,
            ma_50_above_200=1,
            week_52_high=108_000.00,
            week_52_low=45_000.00,
            ...
            signal_summary="bullish",
            volatility_30d=3.5,
            avg_volume_20d=22_000_000_000,
            volume_ratio=1.14,
            news_sentiment_pt=None,
            news_sentiment_en=0.30,
            news_sentiment_combined=0.30,
            news_count_pt=0,
            news_count_en=8,
            news_headline_pt=None,
